 ...
 */
namespace Netresearch\Dhl\LocationFinder\Webservice\Parser;

use Netresearch\Dhl\LocationFinder\Webservice\Parser;
...
class Location implements Parser
{
    ...
    public function parse($parcelLocations)
    {
        ...
        foreach ($parcelLocations as $parcelLocation) {
            ...
            if (is_array($parcelLocation->getPsfServicetypes())) {
